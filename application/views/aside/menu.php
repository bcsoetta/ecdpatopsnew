                    ...
                    <li class="menu-item menu-item-submenu menu-item-open menu-item-here" aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item <?= ($menuActive == 1) ? 'menu-item-active' : '';  ?>" aria-haspopup="true">
                                    <a href="<?=base_url('spmb')?>" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                        <span class="menu-text">SPMB (BC 3.4)</span>
                                    </a>
                                </li>
                                <li class="menu-item <?= ($menuActive == 2) ? 'menu-item-active' : '';  ?>" aria-haspopup="true">
                                    <a href="<?=base_url('valas')?>" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                        <span class="menu-text">VALAS - Kedatangan</span>
                                    </a>
                                </li>
                                <li class="menu-item <?= ($menuActive == 3) ? 'menu-item-active' : '';  ?>" aria-haspopup="true">
                                    <a href="<?=base_url('valas-departure')?>" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
