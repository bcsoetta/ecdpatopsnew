                        ...
                        <table width= "100%">
                            ...
                            <tr>
                                ...
                                <td width="95%">
                                    ...
                                    <br />
                                    <div class="my-div-border"><?= $personal->id_address; ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td width="5%">6. </td>
                        ...
                        <table width= "100%">
                            ...
                            <tr>
                                ...
                                <td width="95%">
                                    Residence Address (Alamat Tempat Tinggal)
                                    <br />
                                    <div class="my-div-border"><?= isset($others->address) ? $others->address : '' ; ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td width="5%">12. </td>
                        ...
                        <table width= "100%">
                            ...
                            <tr>
                                ...
                                <td width="95%">
                                    ...
                                    <br />
                                    <div class="my-div-border"><?= $personal->local_address; ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td width="5%">20. </td>
                        ...
                        <table width= "100%">
                            <tr>
                                ...
                                <td width="95%">
                                    ...
                                    <br />
                                    <input type="checkbox" onclick="return false;" id="decalaration_type" name="decalaration_type">
                                    <label for="decalaration_type"> Arrival (Kedatangan)</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox" onclick="return false;" id="decalaration_type2" name="decalaration_type2"checked>
                    ...
                    <span class="justify">
                        ...
                        <table width="100%" style="border: 1px solid; text-align: center;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; padding-top: 38px;"><br />&nbsp;<br />&nbsp;
                                    <div style="color: grey; font-size: 0.9em; position: relative; top: 1px;">Ditandatangani secara elektronik
                                </div>
                                <?php echo $personal->officer_name; ?> <br />
                                </td>
                            </tr>
                        </table>
                    </span>
